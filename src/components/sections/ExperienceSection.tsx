    ...
    <section id="experience" className="section-padding">
      <div className="container-page">
        <div className="mb-8 max-w-2xl">
          <p className="text-sm font-semibold uppercase tracking-[0.3em] text-slate-500">Pengalaman</p>
          <h2 className="mt-3 text-3xl font-bold tracking-tight md:text-4xl">Pengalaman kerja, magang, dan project.</h2>
        </div>
            ...
            <Card key={experience.id}>
              <div className="grid gap-5 md:grid-cols-[0.75fr_1.25fr]">
                <div>
                  ...
                  <p className="mt-3 text-sm text-slate-500">{formatDateRange(experience.start_date, experience.end_date)}</p>
                </div>
                <div>
                  <p className="leading-7 text-slate-700">{experience.description}</p>
